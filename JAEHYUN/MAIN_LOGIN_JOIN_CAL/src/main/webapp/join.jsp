    ...
    <section class="main_content">
        <div class="join_div">
            <form action="./joinAction.jsp" method="post">
                <input type="text" name="userName" id="inputName" class="name" placeholder="이름">
                <label id="name">이름</label><br>
                <input type="text" name="userID" id="inputId" class="id" placeholder="아이디">
                <input type="button" value="아이디 중복확인" onclick="idCH(inputId.value)"><br>
                ...
                <input type="password" name="" id="inputPw" class="pw" placeholder="비밀번호"><br>
                <label id="pw">비밀번호 확인</label><br>
                <input type="email" name="userEmail" id="inputEmail" class="email" placeholder="qwe@qwe.com"><br>
                <label id="email">이메일</label><br>
