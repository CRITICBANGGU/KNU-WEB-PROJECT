...
<body>
	...
	<aside id="left">
		<ul>
			<li><a href="calAction.jsp" target="iframe">캘린더</a>
			<li><a href="bs.jsp" target="iframe">게시판</a>
	...
	<section id="main">
		<article>
			<iframe name="iframe" src="bs.jsp" frameborder="0" width="440" height="800"></iframe>
		</article>
	</section>
